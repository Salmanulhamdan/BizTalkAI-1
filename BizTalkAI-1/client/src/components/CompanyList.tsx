...
export default function CompanyList({ ainagers, onCompanyClick }: CompanyListProps) {
  return (
    <div className="px-3 sm:px-5 py-3 touch-manipulation" data-testid="list-companies">
      {/* Section Header */}
      <div className="px-2 pb-2 sm:pb-3 flex items-center justify-between">
        <h2 className="text-[10px] sm:text-xs font-semibold text-muted-foreground uppercase tracking-wider">
          Assistants
        </h2>
